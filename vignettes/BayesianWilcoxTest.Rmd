...
group. For sample of $n_x = 8$ values in the first sample and $n_y = 4$ values
...
The package can be obtained from the author's github page and installed 
using the **devtools** package 
(https://CRAN.R-project.org/package=devtools) via
```{r eval = FALSE}
require(devtools)
